<template>
    <div class="min-h-screen bg-[#1f2125] text-gray-100">
      <!-- Actions header (kept minimal to match your mock) -->
      <div class="flex items-center justify-center gap-4 mt-8">
        <button class="px-5 py-2.5 rounded-lg bg-[#5E56C5] hover:brightness-110">New Collaborator</button>
        <button class="px-5 py-2.5 rounded-lg bg-[#5E56C5] hover:brightness-110">Manage Collaborators</button>
        <button class="px-5 py-2.5 rounded-lg bg-[#5E56C5] hover:brightness-110">New Share</button>
      </div>
