...
import studio_logo from './45studio.png';
import studio_logo_dark from './45studio-darkmode.png';

export { base_logo, enterprise_logo, homelab_logo, pro_logo, studio_logo, base_logo_dark, enterprise_logo_dark, homelab_logo_dark, pro_logo_dark, studio_logo_dark};